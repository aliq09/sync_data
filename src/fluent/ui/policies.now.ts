...
UiPolicy({
    ...
    actions: [
        ...
        { field: 'execution_mode', readOnly: true },
        { field: 'trigger_type', readOnly: true },
        { field: 'triggered_by', readOnly: true },
        { field: 'trigger_reference', readOnly: true },
        { field: 'queued_at', readOnly: true },
        { field: 'schedule', readOnly: true },
