...
Test(
    {
        ...
        description:
            '0.3.2 percent comes from execution state, counts, and milestones. Acknowledgement weight is 0. No progress_percent column. No pause.',
        active: true,
    ...
    assertEqual(ack.ack_skipped, true, 'ack flag');
    assertEqual(ack.stage_key, 'finalising', 'ack stage hidden');
    assertEqual(ack.message, 'Acknowledgement skipped (not enabled)', 'ack copy');
