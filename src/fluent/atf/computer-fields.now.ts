...
Test(
    {
        ...
        description:
            '0.4.7: Path A child capture includes installed_on and software. Apply seals those fields onto cmdb_software_instance. Computer include-list and Case 2 alm_hardware.ci stay as they were.',
        active: true,
